...
def test_batch_prediction(
    ...
    #####################################################################
    # add_num=32
    # for layer in [3,4,5,6,7,8]:
    #     for name, param in model.named_parameters():
    #         if f'transformer.h.{layer}.mlp.fc_in.weight' in name:
    #             # print(param, param.shape)
    #             param[-add_num:] = torch.zeros([add_num,param.size(1)])
    #             # print(param)
    #         if f'transformer.h.{layer}.mlp.fc_out.weight' in name:
    #             # print(param, param.shape)
    #             param[:,-add_num:] = torch.zeros([param.size(0), add_num])
    #             # print(param)
