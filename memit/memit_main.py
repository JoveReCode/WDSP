...
from .compute_z import compute_z, get_module_input_output_at_words, find_fact_lookup_idx , train_newblock, knowledge_unlearning
from .memit_hparams import MEMITHyperParams
from .mod_layer import ModifyLinearInput, ModifyLinearOutput
...
def execute_memit(
    ...
    #     print(v.shape)    #  torch.size([4096, 16384])
    ...
    for i, layer in enumerate(hparams.layers):
        ...
        cur_zs = get_module_input_output_at_words(
            ...
            # context_templates=template_list,
